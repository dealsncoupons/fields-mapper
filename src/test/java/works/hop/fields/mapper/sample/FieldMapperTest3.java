...
public class FieldMapperTest3 {

    static final Logger log = LoggerFactory.getLogger(FieldMapperTest3.class);
...
//        Item clone = map(item, Item.class, new FieldMapper3());
//        log.info("{}", clone);

        FieldMapper3 clone4Mapper = new FieldMapper3();
        ...
        FieldMapper3 clone5Mapper = new FieldMapper3();
...
//        log.info("{}", clone5);
    ...
    private static <T> T map(Object source, Class<T> target, FieldMapper3 fieldMapper) {
    ...
    private static void mapBasicValue(Field field, Object source, Object target, FieldMapper3 fieldMapper) {
    ...
    private static void mapListValue(Field field, Object source, Object target, FieldMapper3 fieldMapper) {
        String sourceProperty = field.getName();
        String targetProperty = fieldMapper.targetProperty(sourceProperty).orElse(sourceProperty);
        Field targetField = FieldMapperUtils.instanceField(target.getClass(), targetProperty);
        if (targetField != null) {
    ...
    private static void mapSetValue(Field field, Object source, Object target, FieldMapper3 fieldMapper) {
        String sourceProperty = field.getName();
        String targetProperty = fieldMapper.targetProperty(sourceProperty).orElse(sourceProperty);
        Field targetField = FieldMapperUtils.instanceField(target.getClass(), targetProperty);
        if (targetField != null) {
    ...
    private static void mapMapValue(Field field, Object source, Object target, FieldMapper3 fieldMapper) {
        String sourceProperty = field.getName();
        String targetProperty = fieldMapper.targetProperty(sourceProperty).orElse(sourceProperty);
        Field targetField = FieldMapperUtils.instanceField(target.getClass(), targetProperty);
        if (targetField != null) {
